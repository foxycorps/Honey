...
import type { Heading } from '@honeydocs/honey'
...
function Item({
  ...
  React.useEffect(() => {
    ...
    const toc = document.getElementsByClassName('honey-toc')[0]
...
export default function ToC({
  ...
  return (
    <div className="honey-toc w-64 hidden xl:block text-sm px-4 order-last flex-shrink-0">
      <div className="honey-toc-content overflow-y-auto pr-4 -mr-4 sticky max-h-[calc(100vh-4rem-env(safe-area-inset-bottom))] top-16 pt-8">
